...
from .config import SEQUENCE_LENGTH, PREDICTION_LENGTH
...
class TimeSeriesGNN(nn.Module):
    def __init__(self, num_nodes, in_features, hidden_features, out_features, num_layers=2):
        ...
        self.fc_out = nn.Linear(hidden_features * num_nodes * SEQUENCE_LENGTH, out_features) # Output for all nodes and prediction steps
